...
{
    public class TriptychConverter : JsonConverter<Coin.Triptych>
    {
        public override Triptych Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
        ...
        public override void Write(Utf8JsonWriter writer, Triptych value, JsonSerializerOptions options)
        {
            if (value == null)
            {
