...
namespace Discreet.RPC.Endpoints
{
    public static class StorageEndpoints
    {
        ...
        public static object KVGet(string key)
        {
            ...
            {
                Daemon.Logger.Error($"RPC call to KVGet failed: {ex.Message}", ex);
        ...
        public static object KVPut(string key, string value)
        {
            ...
            {
                Daemon.Logger.Error($"RPC call to KVPut failed: {ex.Message}", ex);
        ...
        public static object KVDel(string key)
        {
            ...
            {
                Daemon.Logger.Error($"RPC call to KVDel failed: {ex.Message}", ex);
        ...
        public static object KVAll()
        {
            ...
            {
                Daemon.Logger.Error($"RPC call to KVAll failed: {ex.Message}", ex);
